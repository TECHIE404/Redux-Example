    ...
    <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          >
            ...
            <input type="number" placeholder="Amount" onChange={(e)=>setIncreaseByAmount(e.target.value)}/>
            <button className="btn btn-primary" onClick={()=>dispatch(count,incrementByAmount(incrementByAmount))}>Apply</button>
          </a>
          <a
            className={styles.card}
          >
